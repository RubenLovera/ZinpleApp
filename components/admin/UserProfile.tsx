  ...
  return (
    <div className="space-y-6">
            ...
            {[
              ...
              <div key={idx}>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="font-semibold text-sm break-all">{field.value}</p>
                  {field.copy && (
                    <Button
                      variant="ghost"
                      size="sm"
      ...
      <div className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Volumen mensual (últimos 6 meses)</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                {paginatedOps.map((op) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="font-semibold text-sm">{op.operation_number}</p>
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    {ben.email && (
                      <div>
                        ...
                        <p className="font-medium break-all">{ben.email}</p>
                      </div>
                    )}
                    {ben.wallet_address && (
                      <div>
                        ...
                        <p className="font-mono text-xs break-all">
                          {ben.wallet_address.substring(0, 20)}...
                        </p>
                      </div>
                    )}
